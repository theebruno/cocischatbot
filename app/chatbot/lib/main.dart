...
final GlobalKey<AnimatedListState> _listKey = GlobalKey();
  List<String> _data = [];
  static const String BOT_URL = "https://cocisbot.herokuapp.com/bot"; // this is our server address
...
//this method receives the json response from our api
void _getResponse(){
...
//this method  inserts the add the reponse to the list
void _insertSingleItem(String message){
_data.add(message); 
    _listKey.currentState.insertItem(_data.length-1);
  }

// this widget builds the chat replies and messages using bubble from pub get
